...
def create_wp_listing(title, content, featured_media_id, images_urls, video_url):
    ...
    # === SEZIONE 9: FORM RICHIESTA MUTUO & VISITA ===
    ...
    mortgage_calculator_html = (
        ...
        f'  <h3 style="font-size:20px; color:#0f172a; margin-top:0; margin-bottom:15px; border-bottom:2px solid #e2e8f0; padding-bottom:8px;">🏦 Calcola e Richiedi Mutuo</h3>\n'
    ...
    contact_box_html = (
        ...
        f'  <p style="color:#94a3b8; font-size:14px; text-align:center; margin-top:0; margin-bottom:20px;">Compila i dati richiesti per essere ricontattato.</p>\n'
